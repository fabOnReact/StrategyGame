...
new_customer = Customer.new(:firstname => :Diego, :surname => :Hernandez, :city => "Long Beach",:task => "Surf e-commerce Website", :seeking_for => "Webdevelopers, App Developers")
new_customer.save

new_customer = Customer.new(:firstname => :Ross, :surname => :Prince, :city => "Sydney",:task => "Social Platform for Educational Purposes", :seeking_for => "Webdevelopers, App Developers, Rails Developer"
new_customer.save
...
new_customer = Developer.find_by(firstname: "Diego")
